typedef enum {
  ...
  CHARACTER_TOKEN,PV_TOKEN,COMPLEX_TOKEN,HEX_TOKEN,NUM_TOKEN,ID_TOKEN,ERREUR_TOKEN,APOST_TOKEN,GUIL_TOKEN
} TOKENS ;
typedef struct {
...
TokenS_Struct ARR_TOK[53] = {{IF_TOKEN,"IF_TOKEN"},{ELSE_TOKEN,"ELSE_TOKEN"},{REPEAT_TOKEN,"REPEAT_TOKEN"},{WHILE_TOKEN,"WHILE_TOKEN"},
