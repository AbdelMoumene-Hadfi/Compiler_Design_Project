typedef enum {
  ...
  LEFT_ASGN_TOKEN,RIGHT_ASGN_TOKEN,PO_TOKEN,PF_TOKEN,AO_TOKEN,AF_TOKEN,PRINT_TOKEN,READLINE_TOKEN,RETURN_TOKEN,
  CHARACTER_TOKEN,PV_TOKEN,COMPLEX_TOKEN,HEX_TOKEN,NUM_TOKEN,ID_TOKEN,ERREUR_TOKEN,APOST_TOKEN,GUIL_TOKEN,TWO_POINT_TOKEN,VIR_TOKEN
} TOKENS ;
typedef struct {
...
TokenS_Struct ARR_TOK[55] = {{IF_TOKEN,"IF_TOKEN"},{ELSE_TOKEN,"ELSE_TOKEN"},{REPEAT_TOKEN,"REPEAT_TOKEN"},{WHILE_TOKEN,"WHILE_TOKEN"},
